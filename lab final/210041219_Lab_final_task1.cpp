...
public:
    ...
    Doc* lend_items(){
        documents[docnum].second--;
        return documents[docnum--].first;
    }
...
int main(void){
    ...
    d[5]= new Journal("j3", auth_list, 2023, "sjdhfg");
    d[6]= new Journal("j4", auth_list, 2004, "sjdhfg");
    d[7]= new Journal("j5", auth_list, 2007, "sjdhfg");
    d[8]= new Entertainment("e2","ef", "saefg", "sffg");
    d[9]= new Entertainment("e3","ef", "saefg", "sffg");

    cout<<"SHOWING LIBRARY CONTENTS: "<<endl;
    lib.library_contents();

    cout<<endl<<"SHOWING ARRAY CONTENTS BEFORE SORTING: "<<endl;
    for(int i=0;i<10;i++){
        cout<<i+1<<"."<<endl;
        d[i]->display_info();
    }
    ...
    cout<<endl<<"SHOWING ARRAY CONTENTS AFTER SORTING: "<<endl;
    for(int i=0;i<10;i++){
        cout<<i+1<<"."<<endl;
        d[i]->display_info();
    }
